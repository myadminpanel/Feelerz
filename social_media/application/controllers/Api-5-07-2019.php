...
{
	$feeling = $this->db->query("SELECT id FROM feeling WHERE name='".$feeling_name."'")->row_array();

	$set_feeling_filter=" AND feeling_id='".@$feeling['id']."'";
}
//var_dump($feeling_name);
//var_dump($this->db->last_query());
//var_dump($feeling);
//var_dump($set_feeling_filter);
 ...
 public function post_delete()
 {
   ...
   public function arvind(){
       ...
       // $query = $this->db->get('users');
        ...
        $query = $this->db->select('*')->from('users')->like('name',$searchs)->get();
  ...
  public function ctest()
      {
        ...
        $result = $this->db->select('*')->from('test')->like('name',$k)->get();
        //var_dump($this->db->last_query());
        if(@$result)
        {
...
$get_post=$this->db->query("SELECT name FROM users WHERE name LIKE '%".$searchs."%' ")->result_array();
//var_dump($this->db->last_query());
