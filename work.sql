...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2019 at 09:18 AM
...
--
-- Table structure for table `about_us_social`
--

CREATE TABLE `about_us_social` (
  `id` int(11) NOT NULL,
  `user_id` varchar(255) NOT NULL,
  `about_us_content` varchar(255) NOT NULL,
  `date_time` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `about_us_social`
--

INSERT INTO `about_us_social` (`id`, `user_id`, `about_us_content`, `date_time`) VALUES
(1, '2', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \\\'Content here, c', '05-04-2019');
...
--
-- Table structure for table `administrators_social`
--

CREATE TABLE `administrators_social` (
  `ADMINID` bigint(20) NOT NULL,
  `name` varchar(100) COLLATE utf8_bin NOT NULL,
  `user_role` int(11) NOT NULL DEFAULT '2',
  `profile_picture` varchar(500) COLLATE utf8_bin NOT NULL,
  `profile_thumb` varchar(500) COLLATE utf8_bin NOT NULL,
...
--
-- Table structure for table `bank_account_social`
--

CREATE TABLE `bank_account_social` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `user_name` varchar(50) COLLATE latin1_bin NOT NULL,
  `acc_no` varchar(50) COLLATE latin1_bin NOT NULL,
  `bank_name` varchar(100) COLLATE latin1_bin NOT NULL,
  `bank_addr` varchar(500) COLLATE latin1_bin NOT NULL,
  `ifsc_code` varchar(25) COLLATE latin1_bin NOT NULL,
  `pancard_no` varchar(20) COLLATE latin1_bin NOT NULL,
  `paypal_account` varchar(50) COLLATE latin1_bin NOT NULL,
  `paypal_email_id` varchar(100) COLLATE latin1_bin NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_bin;

--
-- Dumping data for table `bank_account_social`
--

INSERT INTO `bank_account_social` (`id`, `user_id`, `user_name`, `acc_no`, `bank_name`, `bank_addr`, `ifsc_code`, `pancard_no`, `paypal_account`, `paypal_email_id`, `status`) VALUES
(1, 64, '', '', '', '', '', '', '', 'paypal@digimonk.in', 0);
...
--
-- Table structure for table `blog_categories_social`
--

CREATE TABLE `blog_categories_social` (
  `id` bigint(20) NOT NULL,
  `name` varchar(500) COLLATE latin1_bin NOT NULL,
  `status` varchar(500) COLLATE latin1_bin NOT NULL,
  `category_image` varchar(500) COLLATE latin1_bin NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_bin;

--
-- Dumping data for table `blog_categories_social`
--

INSERT INTO `blog_categories_social` (`id`, `name`, `status`, `category_image`) VALUES
(5, 'Package', '0', 'picture-frame-with-mountain-image_318-4029310.jpg');
...
--
-- Table structure for table `blog_comment_social`
--

CREATE TABLE `blog_comment_social` (
  `id` int(11) NOT NULL,
  `user_id` varchar(500) COLLATE latin1_bin NOT NULL,
  `comment` varchar(500) COLLATE latin1_bin NOT NULL,
  `reating` varchar(500) COLLATE latin1_bin NOT NULL,
  `status` varchar(500) COLLATE latin1_bin NOT NULL,
  `time_zone` varchar(500) COLLATE latin1_bin NOT NULL,
  `country_name` varchar(500) COLLATE latin1_bin NOT NULL,
  `sent_recieved` varchar(500) COLLATE latin1_bin NOT NULL,
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `notification_status` varchar(500) COLLATE latin1_bin NOT NULL,
  `blog_id` varchar(500) COLLATE latin1_bin NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_bin;

--
-- Dumping data for table `blog_comment_social`
--

INSERT INTO `blog_comment_social` (`id`, `user_id`, `comment`, `reating`, `status`, `time_zone`, `country_name`, `sent_recieved`, `created_date`, `notification_status`, `blog_id`) VALUES
(1, '142', 'Good Blog  tis very help for me thank you!!!', '5', '0', 'Asia/Kolkata', '3', '', '2018-11-28 14:05:15', '1', '10');
...
--
-- Table structure for table `buyer_rejected_list_social`
--

CREATE TABLE `buyer_rejected_list_social` (
  `id` int(11) NOT NULL,
  `seller_id` int(11) NOT NULL,
  `buyer_id` int(11) NOT NULL,
  `gig_id` int(11) NOT NULL,
...
--
-- Dumping data for table `buyer_rejected_list_social`
--

INSERT INTO `buyer_rejected_list_social` (`id`, `seller_id`, `buyer_id`, `gig_id`, `message`, `order_id`, `status`, `rejected_request`, `notification_seen`, `created_time`) VALUES
(1, 138, 143, 72, '\'My work is not perfectely', 21, 1, 1, 1, '2018-11-09 11:24:24'),
(2, 138, 143, 72, 'Deepak singh patel', 22, 1, 1, 1, '2018-11-09 11:49:13'),
(3, 138, 143, 72, 'dfhdsvb vhbsdfv bfvfb vfgbgbg', 24, 1, 1, 1, '2018-11-09 12:11:19'),
(4, 138, 143, 72, 'This is not good', 24, 1, 1, 1, '2018-11-09 12:17:57'),
...
--
-- Table structure for table `manage_emoji`
--

CREATE TABLE `manage_emoji` (
  `id` int(11) NOT NULL,
  `emoji name` varchar(500) COLLATE latin1_bin NOT NULL,
  `emoji category` varchar(500) COLLATE latin1_bin NOT NULL,
  `emoji icon` varchar(500) COLLATE latin1_bin NOT NULL,
  `emoji status` varchar(500) COLLATE latin1_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
(100, '', '', '', '', 'pulkit.sharma@digimonk.in', '', 'user_0000007', 'Pulk@2913', '20392103239', 0, '', '0.00', '0.00', '0.00', '0.00', '', '', 'Pulkit Sharma', '', 0, 0, 0, '', '', 0, 0, '', NULL, NULL, '', '', '', 0, '', '', '', 0, '', 0, 1, '', NULL, '', '', '', '', 'No');
...
CREATE TABLE `users` (
  ...
  `stype_of_login` varchar(500) NOT NULL,
  `no_of_login` varchar(500) NOT NULL,
  `status` varchar(500) NOT NULL DEFAULT '0',
  `created_date` varchar(500) NOT NULL,
  `last_login` varchar(500) NOT NULL,
  `social_login_id` varchar(500) NOT NULL,
  `friend` varchar(255) NOT NULL,
  `send_friend_request` varchar(255) NOT NULL,
  `get_friend_request` varchar(255) NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `contact`, `profileimage`, `gender`, `dob`, `country`, `stype_of_login`, `no_of_login`, `status`, `created_date`, `last_login`, `social_login_id`, `friend`, `send_friend_request`, `get_friend_request`, `last_logout`) VALUES
(2, 'aaaaaaaaaa', 'dsp2@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '7999908258', 'user_default.png', 'Male', '30-09-2019', 'India', 'Self', '0', '0', '30-03-2019', '31-03-2019 07:03:04am', '', '3,8', '4', '5', ''),
(8, 'Arvind Singh', 'arvind@gmail.com', '96e79218965eb72c92a549dd5a330112', '9907559343', 'user_default.png', '', '', 'india', 'Self', '', '0', '30-03-2019 13:03:06pm', '2019/04/11 17:30:15', '', '5,4', '', '', ''),
(3, '', 'dspatel@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '8435144608', 'user_default.png', '', '', 'india', 'Self', '', '0', '30-03-2019 08:03:14am', '', '', '2', '5', '', '2019/04/11 16:46:38'),
(4, 'Gopal Mahor', 'gopalmahor@digimonk.in', '827ccb0eea8a706c4c34a16891f84e7b', '457951245635', 'user_default11.png', 'Male', '', 'india', 'Self', '', '0', '30-03-2019 08:03:43am', '', '', '2', '6,5', '', '2019/04/11 16:47:00'),
(5, 'Deepak Patel', 'dsp@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '8435144608', 'user_default.png', '', '', 'india', 'Facebook', '', '0', '30-03-2019 10:03:35am', '', 'Deepak@123', '', '2', '4,3', ''),
(6, 'Gopal mahor', 'dspsdgrg@gmail.com', '19bf943c688686060348a3bef7a6ee26', '84351446082345', 'user_default.png', '', '', 'india', 'Self', '', '0', '30-03-2019 11:03:31am', '', '', '', '', '4', ''),
(7, 'Deepak Patel', 'dspsdfsdgrg@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '446082345', 'user_default.png', '', '', 'india', 'Self', '', '0', '30-03-2019 11:03:16am', '', '', '', '', '', ''),
(9, 'around as', 'arvind2@gmail.com', '96e79218965eb72c92a549dd5a330112', '990755934', 'user_default.png', '', '', 'india', 'Self', '', '0', '30-03-2019 13:03:02pm', '10-04-2019 11:04:56am', '', '', '', '', ''),
(10, 'pulkit sharma', 'pulkit.sharma@digimonk.in', 'e10adc3949ba59abbe56e057f20f883e', '7000761154', 'user_default.png', '', '', 'india', 'Self', '', '0', '31-03-2019 06:03:21am', '02-04-2019 06:04:50am', '', '', '', '', ''),
(11, 'arvind Singh', 'arvind4@gmail.com', '776a9f70051251022391a0680c037794', '9907559344', 'user_default.png', '', '', 'india', 'Self', '', '0', '31-03-2019 07:03:51am', '', '', '', '', '', ''),
(12, 'Arvind Singh Kushwah', 'lvu191@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', '', 'user_default.png', '', '', '', 'Facebook', '', '0', '31-03-2019 10:03:28am', '', '2050085265029469', '', '', '', ''),
(13, 'Arvind Singh Kushwah', 'arvindsinghkshwh38@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', '', 'user_default.png', '', '', '', 'Twitter', '', '0', '31-03-2019 10:03:37am', '', '188665178', '', '', '', ''),
(14, 'Arvind Singh ', 'lvu191@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', '', 'user_default.png', '', '', '', 'Google', '', '0', '31-03-2019 10:03:49am', '', '108034378833289159093', '', '', '', ''),
(15, 'Arvind Kushwah ', 'arvind.kushwah@digimonk.in', 'd41d8cd98f00b204e9800998ecf8427e', '', 'user_default.png', '', '', '', 'Google', '', '0', '31-03-2019 10:03:11am', '', '103796204427180585116', '', '', '', '');
...
--
-- Indexes for table `about_us_social`
--
ALTER TABLE `about_us_social`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `administrators_social`
--
ALTER TABLE `administrators_social`
  ADD PRIMARY KEY (`ADMINID`);
...
--
-- Indexes for table `bank_account_social`
--
ALTER TABLE `bank_account_social`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `blog_categories_social`
--
ALTER TABLE `blog_categories_social`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `blog_comment_social`
--
ALTER TABLE `blog_comment_social`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `buyer_rejected_list_social`
--
ALTER TABLE `buyer_rejected_list_social`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `manage_emoji`
--
ALTER TABLE `manage_emoji`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `about_us_social`
--
ALTER TABLE `about_us_social`
...
--
-- AUTO_INCREMENT for table `administrators_social`
--
ALTER TABLE `administrators_social`
...
--
-- AUTO_INCREMENT for table `bank_account_social`
--
ALTER TABLE `bank_account_social`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `blog_categories_social`
--
ALTER TABLE `blog_categories_social`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `blog_comment_social`
--
ALTER TABLE `blog_comment_social`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `buyer_rejected_list_social`
--
ALTER TABLE `buyer_rejected_list_social`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT for table `manage_emoji`
--
ALTER TABLE `manage_emoji`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
