...
class Payments extends CI_Controller {
...

	{
		...
		if (isset($pay_data['created_at'])) {
			...
			$gig_link= base_url().'package-preview/'.$pay_data['title'].'/'.$pay_data['id'];
...

	{
		...
		if (isset($pay_data['created_at'])) {
			...
			$amt = $pay_data['item_amount']-($pay_data['item_amount']/$pay_data['commision']);
...

		{
...

			{
			 ...
			 $h_all.='<tr>
				...
				$gig_preview_link  = base_url().'package-preview/'.$pay_data['title'].'/'.$pay_data['id'];
