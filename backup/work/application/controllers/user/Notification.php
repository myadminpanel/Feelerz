...
class Notification extends CI_Controller{
    public function __construct() {
	   ...
	   if($data['key'] == 'email_tittle'){
		$this->email_tittle =!empty($data['value']) ? $data['value'] : 'Packages' ;
		}
				...
				{               
					$html .= '<li class="media notification-message">
						<a onclick="change_notification_status('.$id.', \''.$status_s.'\',\'sales\');" href="javascript:;">
								...
								<div class="media-body">
										<p class="m-0 noti-details"><span class="noti-title">'.$name.'</span> has purchased your package <span class="noti-title">"'.str_replace("-"," ",$title).'"</span></p>
										<p class="m-0"><span class="notification-time">'.$time_taken.'</span></p>
								</div>
						</a>
						</li>';  
				...
				{               
					$html .= '<li class="media notification-message">
						<a onclick="change_notification_status('.$id.', \''.$status_s.'\',\'payments\');" href="javascript:;">
								...
								<div class="media-body">
								<p class="m-0 noti-details">Admin released payment for a completed package <span class="noti-title">"'.str_replace("-"," ",$title).'"</span></p>
										<p class="m-0"><span class="notification-time">'.$time_taken.'</span></p>
								</div>
						</a>
						</li>';  
				...
				elseif ($notifications['status']=='buyer_cancel') 
				{
					...
					$html .= '<li class="media notification-message">
						<a onclick="change_notification_status('.$id.', \''.$status_s.'\',\'sales\');" href="javascript:;">
								...
								<div class="media-body">
								<p class="m-0 noti-details"><span class="noti-title">'.$name.'</span> cancel the packages of <span class="noti-title">"'.str_replace("-"," ",$title).'"</span></p>
								<p class="m-0"><span class="notification-time">'.$time_taken.'</span></p>
								</div>
								</a>
								</li>';
				...
				elseif ($notifications['status']=='seller_cancel') 
				{
					...
					$html .= '<li class="media notification-message">
						<a onclick="change_notification_status('.$id.', \''.$status_s.'\',\'purchases\');" href="javascript:;">
								...
								<div class="media-body">
								<p class="m-0 noti-details"><span class="noti-title">'.$name.'</span> decline the packages of <span class="noti-title">"'.str_replace("-"," ",$title).'"</span></p>
								<p class="m-0"><span class="notification-time">'.$time_taken.'</span></p>
								</div>
								</a>
								</li>';
				...
				{               
					$html .= '<li class="media notification-message">
						<a onclick="change_notification_status('.$id.', \''.$status_s.'\',\'payments\');" href="javascript:;">
								...
								<div class="media-body">
								<p class="m-0 noti-details">Admin released cancel payment for a package <span class="noti-title">"'.str_replace("-"," ",$title).'"</span></p>
										<p class="m-0"><span class="notification-time">'.$time_taken.'</span></p>
								</div>
						</a>
						</li>';  
				...
				{               
					$html .= '<li class="media notification-message">
						<a onclick="change_notification_status('.$id.', \''.$status_s.'\',\'payments\');" href="javascript:;">
								...
								<div class="media-body">
								<p class="m-0 noti-details">Admin released decline payment for a package <span class="noti-title">"'.str_replace("-"," ",$title).'"</span></p>
										<p class="m-0"><span class="notification-time">'.$time_taken.'</span></p>
								</div>
						</a>
						</li>';  
    ...
    if ($total_seconds >= $intervals['year'])
    {
        $total_seconds = floor($total_seconds/$intervals['year']);
         $time_taken =  $total_seconds == 1 ? $total_seconds . ' year ago' : $total_seconds . ' years ago';
            ...
            $html .= '<li class="media notification-message">
                    <a href="'.base_url().'package-preview/'.$title.'/'.$notifications["id"].'">
                            <div class="media-left">
                                    <img width="32" class="img-circle" src="'.$image.'" alt="'.$username.'">
                            </div>
                            <div class="media-body">
              ...
              elseif ($notifications['status']=='own_buying') 
            {
                ...
                $html .= '<li class="media notification-message">
                    <a href="'.base_url().'pakage-preview/'.$title.'/'.$notifications['id'].'">
                            <div class="media-left">
                                    <img width="32" class="img-circle" src="'.$image.'" alt="'.$username.'">
                            </div>
                            <div class="media-body">
...
$result = $query->result_array();
  foreach($result as $notifications)
   ...
   echo "username ".$username." name "	.$name ." title " . $title . " Owner of gig ".$owner_of_gig['fullname'] ." Owner of gig username " .$owner_of_gig['username'] ." Owner email " .$owner_of_gig['email'] . " buyer email " .$buyer_email;
		...
		$gig_preview_link  = base_url().'package-preview/'.$title.'/'.$notifications['id'] ;
