...
class Footer_submenu extends CI_Controller{
    ...
    public function create()
    {
        ...
        if($this->input->post('form_submit'))
        {
            ...
            if($this->db->insert('footer_submenu',$data))
            {
				...
				$message="<div class='alert alert-success text-center fade in' id='flash_succ_message'></div>";
    ...
    public function edit($id)
    {
        ...
        if($this->input->post('form_submit'))
        {
            ...
            if($this->db->update('footer_submenu',$data))
            {
					  ...
					  $message="footer menu edited successfully.";
  ...
  public function footer_set_operation()
  {
     $ids=$this->input->post("id");
    $operation=$this->input->post("operation");
    $this->admin_panel_model->set_operation_for_footer_sub_menu($ids,$operation);
  }  
