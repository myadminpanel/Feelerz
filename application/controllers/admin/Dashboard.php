...
// 	$this->data['price_of_gig']        = 	$this->admin_panel_model->gig_price();	
	...
	if(($this->session->userdata('admin_time_zone')))
     {     
  	 ...
  	 $set_RES=$this->session->userdata('copy_right_year');
  	 //$set_RES=true;
	if(!$set_RES)
		{
	...
	{      
	   // $this->admin_panel_model->my_join();
...
// 		$this->data['dashboard_details']  = $this->admin_panel_model->dashboard_details();
	    $this->data['total_user_count'] = $this->admin_panel_model->total_user_count();
	   // $this->data['total_country_count'] = $this->admin_panel_model->total_country_count();
	    $this->data['total_feeling_count'] = $this->admin_panel_model->total_feeling_count();
	    $this->data['total_reported_count'] = $this->admin_panel_model->total_reported_count();
	    $this->data['total_post_count'] = $this->admin_panel_model->total_post_count();
	    $this->data['my_join'] = $this->admin_panel_model->my_join();
