...
public function test_email_dsp(){
$email="deepaksinghpatel052@gmail.com";
$mail_message="<h1>This is test mail from feelerzapp</h1>";
$this->email->to($email);
$this->email->from($this->data['send_by_email'],'dawerlee');
$this->email->subject('Test account');
