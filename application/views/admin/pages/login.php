...
<html>
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/css/login-register2.css" rel="stylesheet" type="text/css" />
        ...
        <div class="login-container">
            <div class="form-container">
                <div class="text-center logo-container sp-logo-class">
                        ...
                        <img src="http://digimonk.net/social_media/assets/feelerz.png" alt="logo" class="img-responsive">
            ...
            if($this->session->flashdata('message')) {  ?>
                <div class="alert alert-danger text-center fade in" id="flash_succ_message"><?php echo $this->session->flashdata('message');?></div>
