<div class="main-content small-gutter">
          ...
          <div class="col-lg-12 col-xl-12 mb-2">
                            <div class="bg-white padding-25 h-100">
                                <h4 class="mt-0 box-title">Images List</h4>
                    ...
                    <div class="col-sm-12 col-lg-4 col-xl-4">
                        ...
                        <button id="ids_for_delete" class="btn btn-danger btn-raised ripple">
              ...
              <div class="box update" style="margin: 0;">
                <div class="box-header">
                  <div class="custom-control custom-checkbox" style="float:left;">
                     <input type="checkbox" class="custom-control-input checkitem" name="same[]" value="<?php echo $imagedata['id'];?>" id="tableCheckbox1_<?php echo $imagedata['id'];?>">
                     <input type="hidden" class="custom-control-input checkitem" name="same[]" >
                       <label class="custom-control-label" for="tableCheckbox1_<?php echo $imagedata['id'];?>"></label>
                   </div>
                      <h3><a href=""><img src="https://goo.gl/oOD0V2" alt="">Mr. X</a>
                        <span style="margin-top: 0px;">March 21,18:45pm <i class="fa fa-globe"></i></span>
                      </h3>
                  ...
                  <div class="box-content">
                    <div class="content">
                      <p> <?php echo $imagedata['description']; ?></p>
                      
                    <div class="img sam"><img src="<?php base_url()?>../assets/images/<?php echo $imagedata['image']; ?>" ></div>
                    </div>
                  </div>
                      <div class="box-likes">
                        <div class="row">
